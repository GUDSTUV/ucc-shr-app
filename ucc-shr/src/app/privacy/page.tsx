        ...
        <div className="mx-auto max-w-4xl px-6 lg:px-8">
          <div className="sm:p-12">
            ...
            <div className="prose prose-navy max-w-none space-y-6 text-gray-600">
              ...
              <h2 className="text-xl font-bold text-navy">3. Confidentiality and Anonymity</h2>
              <p>
              ...
              <h2 className="text-xl font-bold text-navy">5. Your Rights</h2>
              <p>
              ...
              <h2 className="text-xl font-bold text-navy">6. Contact Us</h2>
              <p>
